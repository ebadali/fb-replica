...
public class UnansweredFriendRequestServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<Person> unansweredFriendRequests = UserDAO._instance.GetFriends(personId, Data.PENDING);
			 ...
			 * "<title>Servlet UnansweredFriendRequestServlet</title>");
			 * out.println("</head>"); out.println("<body>"); out.println(
			 * "<h1>Servlet UnansweredFriendRequestServlet at " +
